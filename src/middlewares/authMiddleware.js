...
export const authMiddleware = async (req, res, next) => {
    ...
    //compare the front end user's access token to our secret access token using jsonwebtoken. If it matches, then it should spit out an object containing the user id that verifies them
